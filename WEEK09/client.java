...
public class client {
    ...
    public static void main(String[] args) throws Exception {
        URL url = new URL("http://localhost/hello/Hello");
        ...
        message = message + "<env:Header/><env:Body><ns0:sayHello>";
        message = message + "<arg0>클라이언트에서 보내는 메세지</arg0>";
        message = message + "</ns0:sayHello></env:Body></env:Envelope>";

        /*
         * byte data[] = new byte[1024]; int size;
         * 
         * while ((size = filein.read(data)) != -1) { out.write(data, 0, size);
         * out.flush(); }
         */
