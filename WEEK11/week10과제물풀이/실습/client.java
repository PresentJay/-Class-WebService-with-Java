...
public class client {
    ...
    public static void main(String[] args) throws Exception {
        ...
        message = message + "<env:Header/><env:Body><ns0:setABC>";
        ...
        message = message + "<arg1>정현재</arg1>";
        message = message + "<arg2>인제대학교</arg2><arg2>컴퓨터공학부</arg2>";
        message = message + "</ns0:setABC></env:Body></env:Envelope>";
